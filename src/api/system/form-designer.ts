export const formDesignerBaseApi = 'admin/form-design/';

export const getFormDesignPageApi = `${formDesignerBaseApi}page`;
export const createFormDesignApi = `${formDesignerBaseApi}create`;
